                ...
                {/* <div className={style.profile}>
                    <div className={style.dropdown}>
                        <button onClick={toggleDropdown} className={style['dropdown-toggle']}>
                            <div className={style.circle}>AK</div>
                            <div className={style['button-text']}>
                                <span>Άννα Κοσμίδη</span>
                                <span className={style.id}>sdi2000107</span>
                            </div>
                            <FontAwesomeIcon icon={faBars} className={style['menu-icon']}/>
                        </button>
                        {dropdownOpen && (
                            <div className={`${style['dropdown-content']} ${dropdownOpen ? style.show : ''}`}>
                                <a className={style.profile} href="/"><HiUserCircle/> Προφίλ</a>
                                <a className={style.logout} href="/"><HiArrowRightOnRectangle/>Αποσύνδεση</a>
                                <a className={style['home-page']} href="/"><HiHome/>Αρχική</a>
                            </div>
                        )}
                    </div>
                </div> */}
